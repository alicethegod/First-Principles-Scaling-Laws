# -*- coding: utf-8 -*-
"""
Core Experiment Logic Module (MLP_D)

This file encapsulates the core, reusable components of the experiment.
Compared to the previous version, this version ensures the stability and 
reproducibility of random seed settings across different platforms and 
multi-process environments, serving as a stable foundation for the final validation experiments.
"""
import torch
...
class TheoryAnalyzer:
    ...
    def _build_graph(self):
        ...
        node_counter = 0
        layer_map = {}
        # Assuming the first layer is Linear and provides in_features
...
def run_training_task(args):
    ...
    # Model initialization is also controlled by the seed set above
    model = MLP().to(device)
